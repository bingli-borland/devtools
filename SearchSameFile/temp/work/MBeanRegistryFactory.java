...
/*
 *   $Id: MBeanRegistryFactory.java,v 1.11 2007/05/05 05:25:35 tcfujii Exp $
 *   @author: alexkrav
 *
 *   $Log: MBeanRegistryFactory.java,v $
 *   Revision 1.11  2007/05/05 05:25:35  tcfujii
 ...
 *   The com.tongweb.admin related mbeans are loaded during the startup of instance in the mbeanserver of the instance which shouldn't be done. Provided a check to do this only when the server is DAS.
 ...
 *   Reviewed by:   Kedar Mhaswade
 *   Description: The validator and the com.tongweb.admin.config beans are loaded for all the instances which is not necessary. Modified the code to not load them.
 *
...
import com.tongweb.admin.AdminContext;
import com.tongweb.config.api.ServerHelper;
